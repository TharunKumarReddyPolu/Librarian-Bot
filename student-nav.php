            ...
            <nav class="nav" >
                <div >
                    ...
                    <div  >
                            <div id="small-pic">
                              <a href="student-profile.php">
                                <?php echo '<img src="data:image/jpeg;base64,'.base64_encode($row['Image'] ).'" width="44" height="44" style="border-radius: 50%;" >' ?> 
                              </a>
                            </div>
                            <br>
                            <div class="p" id="large-pic" >
                                <a href="student-profile.php">
                                  <?php echo '<img src="data:image/jpeg;base64,'.base64_encode($row['Image'] ).'" width="165" height="178" style="border-radius: 50%;margin-bottom:10px;" >' ?> 
                                </a>
                                <p style="color:white;">
                                  <?php
                    ...
                    <div class="nav__list">
                        ...
                        <a href="student-home.php" class="nav__link active">
                            <ion-icon name="home-outline" class="nav__icon"></ion-icon>
                            <span class="nav__name">Dashboard</span>
                        </a>

                        <a href="student-profile.php" class="nav__link active1">
                            <ion-icon name="person-outline" class="nav__icon"></ion-icon>
                            <span class="nav__name">Profile</span>
                        </a>

                        <a href="student-mybooks.php" class="nav__link active2">
                            <ion-icon name="book-outline" class="nav__icon"></ion-icon>
                            <span class="nav__name">MyBooks</span>
                        </a>

                        <a href="student-fine.php" class="nav__link active3">
                        ...
                        -->        
                        <a href="student-circular.php" class="nav__link active4">
