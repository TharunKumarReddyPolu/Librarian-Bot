...
<?php
  ...
  ?>
  <a href="librarian-studentrequest.php"><button style="float:right;margin-top:40px;margin-right:40px;width:8%;" class="button button1">REQUESTS</button></a>
<form action="librarian-allmembers.php" method="post">
  <div>
      <input type="text" name="valueToSearch" placeholder="Search..." value="<?php echo $valueToSearch ;?>" style="float:left;">
...
?>
      <tr>
        ...
        <td><a href="librarian-deletemember.php?RollNumber=<?php echo $row['RollNumber'];?>" onclick = "return conf('<?php echo $row['RollNumber'];?>','<?php echo $_SESSION['username'];?>')"><button  class="button button2" ><ion-icon name="trash-bin" class="nav__icon" ></ion-icon></button></a></td>
      </tr>
    <?php
      $k=$k+1;
      }
