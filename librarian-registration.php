...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  ...
  if (!$conn){
    ...
    $existSql = "SELECT * FROM `librarians` WHERE FacultyId = '$facultyid' or Email = '$email' or Mobile = '$mobile'";
    ...
    if($numExistRows > 0){
        ...
        if(($password == $cpassword)){
            ...
            $sql = "INSERT INTO librarians (FullName, FacultyId, Gender,DateOfBirth,Branch,YearOfJoining,YearOfStudy,Mobile,Email,Password,Image,Status) VALUES ('$fullname','$facultyid','$gender','$dob','$branch','$yearofjoining','$yearofstudy','$mobile','$email','$hash','$image','P')";
        ...
        <div class="row">
                <div class="bord">
                    <form action="" method="POST" enctype="multipart/form-data" onSubmit = "return checkPassword(this)">
                        ...
                        <input type="username" placeholder="Faculty Id" name="facultyid" required/>
