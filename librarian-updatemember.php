...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if($im==1)
    {
        $sql = "UPDATE `students` SET `FullName` = '$fullname', `Gender` = '$gender',`DateOfBirth` = '$dob', `Branch` = '$branch',`YearOfStudy` = '$yearofstudy', `YearOfJoining` = '$yearofjoining', `Mobile` = '$mobile', `Email` = '$email', `Image`='$image' WHERE `students`.`RollNumber` = '$RollNumber' ";
    }
    else
    {
        $sql = "UPDATE `students` SET `FullName` = '$fullname', `Gender` = '$gender',`DateOfBirth` = '$dob', `Branch` = '$branch',`YearOfStudy` = '$yearofstudy', `YearOfJoining` = '$yearofjoining', `Mobile` = '$mobile', `Email` = '$email' WHERE `students`.`RollNumber` = '$RollNumber' ";
    }
        ...
        <div class="row">
                <div class="bord">
                    <form action="" method="POST" enctype="multipart/form-data" onSubmit = "return checkPassword(this)">
                        ...
                        <br><br>
                        <button type="submit" onclick = "return conf('<?php echo $row['RollNumber'];?>')" >UPDATE</button>
                    </form>
                </div>    
        </div>
    </body>
